...
if __name__ == '__main__':
    ...
    templater = Templater(vendor_os='enterasys', config_blocks=['tacacs'])
    ...
    device_config_list = {}
    nornir_filtered = NETWORK_HANDLER.get_device_filtered(platform='enterasys')
    for host in nornir_filtered.inventory.hosts.values():
        ...
        # device_config_list[host.hostname] = 'clear tacacs server 2'
